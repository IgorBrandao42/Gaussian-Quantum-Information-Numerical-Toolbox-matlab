...
T     =         [  1e-1;    1e-1;    1e-1];      % Initial temperature of each particle             [K]
T_environment = [  1e-1;    1e-1;    1e-1];      % Temperature for the environment of each particle [K]
...
t = linspace(0, 2e-5, 1e+4);                     % Time stamps for the calculations


%% Example of a complete simulation
% Create a simulation variable for a system with 3 particles and an optical cavity
complete = simulation(omega, g, gamma, T, T_environment, Delta, kappa);
